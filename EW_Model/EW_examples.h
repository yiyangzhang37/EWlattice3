...
void EW_CSB_OneBubble(const int n_rows, const int n_cols, const std::string& method = "unperturbed");
void EW_CSB_TwoBubbles(const int n_rows, const int n_cols, const std::string& method = "unperturbed");

...
private:
	...
	//Number of processes for dim 0 and dim 1
	//dim0 <-> grid_size_[1]
	//dim1 <-> grid_size_[0]
	//suppose a 3D lattice (x,y,z), dim0 <-> z, dim1 <-> y.
	int grid_size_[2]; 
	...
	// lat_world_comm_: communicator that controls all the computing processes.
	// world_comm_: communicator that controls all the processes, including IO processes.
	// dim0_comm_: communicator array with size grid_size_[1].
	// dim1_comm_: communicator array with size grid_size_[0].
